...
<title>Fixgeek4u - Computer & Mobile Repair HTML Template</title>
<!-- Plugins CSS -->
...
<section class="error-area inner-content-wrapper">
  <div class="container">
        ...
        <div class="single-testimonial-slide">
          <div class="testimonial-item">
            ...
            <div class="testimonial-author">
              <div class="author-image"> <img src="http://via.placeholder.com/50x50/000/fff" alt=""> </div>
...
<div class="brand-wrapper">
  <div class="container">
    <div class="owl-carousel owl-theme brand-slider">
      <div class="item"> <a target="_blank" href="JavaScript:Void(0)"> <img src="images/client-logo-1.png" alt="" title=""></a> </div>
      <div class="item"> <a target="_blank" href="JavaScript:Void(0)"> <img src="images/client-logo-2.png" alt="" title=""></a> </div>
      <div class="item"> <a target="_blank" href="JavaScript:Void(0)"> <img src="images/client-logo-3.png" alt="" title=""></a> </div>
      <div class="item"> <a target="_blank" href="JavaScript:Void(0)"> <img src="images/client-logo-4.png" alt="" title=""></a> </div>
      <div class="item"> <a target="_blank" href="JavaScript:Void(0)"> <img src="images/client-logo-2.png" alt="" title=""></a> </div>
      <div class="item"> <a target="_blank" href="JavaScript:Void(0)"> <img src="images/client-logo-1.png" alt="" title=""></a> </div>
      <div class="item"> <a target="_blank" href="JavaScript:Void(0)"> <img src="images/client-logo-3.png" alt="" title=""></a> </div>
      <div class="item"> <a target="_blank" href="JavaScript:Void(0)"> <img src="images/client-logo-4.png" alt="" title=""></a> </div>
        ...
        <div class="col-lg-4 col-md-6 col-12"> 
          ...
          <div class="single-widget footer-news widget">
            ...
            <div class="single-f-news">
              <div class="post-thumb"><a href="javascript:void(0)"><img src="http://via.placeholder.com/600x400/000/fff" alt=""></a></div>
              <div class="content">
                <p class="post-meta">
                  <span class="post-date"><i class="fa fa-clock-o"></i>April 15, 2020</span>
                </p>
                <h4 class="title"><a href="blog-details.html">We Provide you Best &amp; Computer Repair Service</a></h4>
              </div>
            </div>
            <!--/ End Single News --> 
            <!-- Single News -->
      ...
      <div class="row">
        <div class="col-12">
          <div class="copyright-content"> 
            <!-- Copyright Text -->
            <p>&copy; <span id="year"></span> Fixgeek4u. Designed By sbtechnosoft</p>
          </div>
        </div>
      </div>
    </div>
